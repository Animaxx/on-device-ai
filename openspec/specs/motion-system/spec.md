...
## Purpose
Defines the motion/animation architecture for the On Device AI website. Ensures consistent, performant, and accessible animations using a centralized MotionController pattern, standardized motion tokens, and reduced-motion support.
## Requirements
